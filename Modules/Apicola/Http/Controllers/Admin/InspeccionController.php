...
{
    /**
     * Muestra la vista de Registro e Inspección de colmenas.
     */
    public function index(Request $request)
    {
        $selectedColmena = $request->get('colmena', 'COL-013');
        return view('apicola::Admin.Colmenas.inspeccion', compact('selectedColmena'));
    }
    ...
    /**
     * Almacenar una nueva inspección / visita.
     */
